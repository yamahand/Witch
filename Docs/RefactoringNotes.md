...
| 10 | GetComponent が dynamic_cast 線形探索 | ⬜ 未（意図的保留） | プロファイル待ち |
...
### 10. GetComponent が dynamic_cast の線形探索 — ⬜ 未対応（意図的に保留 / プロファイル待ち）
[GameObject.h:100](../Engine/Include/WitchEngine/Scene/GameObject.h) —
